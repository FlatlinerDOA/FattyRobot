namespace Fatty.Brain.Modules.Output
{
    ...
    public enum CtrlSpeeds
    {
        Min = 0, Mid = 5000, Max = 10000
    }
    ...
    public sealed class MotorControl : InterpreterBase
    {
        ...
        public override IObservable<Intent> InitializeAsync()
        {
            DebounceInit();
            GpioInit();
        ...
        private void SetRobotDirection(CtrlCmds direction, CtrlSpeeds speed)
        {
