...
namespace Fatty.Brain.Cognition
{
    public sealed class Educational : InterpreterBase
    {
        private readonly RandomQueue<string> explanations = new RandomQueue<string>()
        {
            ...
            "I move using two motors called continuous rotation servos. These are just motors that run at a very low power and very slow speed, but they can be very accurate in how much they rotate, which is useful for a robot like me.",
